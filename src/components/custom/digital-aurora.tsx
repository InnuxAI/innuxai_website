      ...
      void main() {
        ...
        for (int i=0; i<MARCH_STEPS; i++) {
            ...
            if (density > 0.0) {
                ...
                // Deep Rainbow palette (vec3(0,2,4) is standard rainbow phase)
                // Darkened base (0.2) and reduced amplitude (0.4) to prevent overwhelming white text
                vec3 auroraColor = 0.2 + 0.4 * cos(iTime * 0.5 + p.y * 2.0 + vec3(0,2,4));
                // Significantly reduce intensity (0.06 factor) to keep it as a subtle background
                col += auroraColor * density * 0.06 * uColorIntensity;
            }
            t += 0.1;
        }
