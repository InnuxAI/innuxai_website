...
export function MCPComplianceCard() {
    return (
        <div className="relative flex h-full w-full flex-col overflow-hidden rounded-xl bg-gray-50 dark:bg-neutral-950 shadow-2xl border border-gray-200 dark:border-neutral-800 transition-colors duration-300">
            ...
            <div className="flex items-center gap-2 border-b border-gray-200 dark:border-neutral-800 bg-white/50 dark:bg-neutral-900/50 p-3 backdrop-blur-sm z-20">
                ...
                <span className="text-xs font-semibold text-gray-900 dark:text-white">Protocol Status</span>
                <div className="ml-auto flex items-center gap-1.5">
                    <span className="text-[10px] text-gray-400 dark:text-neutral-500">Universal Standard</span>
            ...
            <div className="relative flex-1 flex w-full flex-col items-center justify-center overflow-hidden">
                ...
                <div className="absolute flex h-full w-full items-center justify-center">
                    <div className="h-[150px] w-[150px] rounded-full border border-gray-200 dark:border-white/5" />
                    <div className="absolute h-[250px] w-[250px] rounded-full border border-gray-200 dark:border-white/5" />
                </div>

                {/* Central Node */}
                <div className="z-10 flex h-20 w-20 items-center justify-center rounded-full bg-white dark:bg-neutral-900 shadow-[0_0_40px_-5px_rgba(16,185,129,0.3)] border border-emerald-100 dark:border-emerald-900/30">
                    <Icons.mcp />
                </div>

                {/* Orbiting Icons */}
                <OrbitingCircles iconSize={35} radius={90} reverse speed={1.5} className="border-none bg-transparent">
                    <Icons.gemini />
                    <Icons.openai />
                    <Icons.claude />
                </OrbitingCircles>

                <OrbitingCircles iconSize={28} radius={140} speed={1} className="border-none bg-transparent opacity-70 grayscale hover:grayscale-0 transition-all duration-300">
                    <Icons.whatsapp />
                    <Icons.notion />
                    <Icons.googleDrive />
                    <Icons.gmail />
...
const Icons = {
    mcp: () => (
        <svg
            ...
            className="text-emerald-600 dark:text-emerald-400 fill-current"
        >
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient gradientUnits="userSpaceOnUse" id="lobe-icons-gemini-fill-0" x1="7" x2="11" y1="15.5" y2="12">
                        <stop stopColor="#08B962"></stop><stop offset="1" stopColor="#08B962" stopOpacity="0"></stop>
                    </linearGradient>
    ...
    openai: () => (
        <div className="bg-white p-1 rounded-full shadow-sm">
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="fill-black">
    ...
    whatsapp: () => (
        <div className="bg-white p-1 rounded-full shadow-sm">
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#25D366]">
    ...
    notion: () => (
        <div className="bg-white p-1 rounded-full shadow-sm">
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-black">
