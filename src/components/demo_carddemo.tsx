...
export function ProductShowcaseCard() {
  return (
    ...
    //   )}
    // </Expandable>
    <Expandable expandDirection="both" expandBehavior="push" expandMode="hover">
  <ExpandableTrigger>
    <ExpandableCard collapsedSize={{ width: 400, height: 100 }} expandedSize={{ width: 500, height: 350 }}>
      <ExpandableCardHeader className="p-0 m-0">
        {/* <Badge variant="secondary" className="bg-green-100 text-green-800">
          Step 2: AI Draft
        </Badge>
        <h3 className="font-semibold text-lg">AI Generates Contract</h3> */}
            <MinimalCard>
      ...
      <ExpandableCardContent>
        {/* <p className="text-sm mb-2">
          Innuxai's AI pulls email threads and auto-creates a contract using your preferred template.
        </p> */}
        <ExpandableContent preset="fade">
          {/* <img src="/contract-template-demo.png" alt="Contract Demo" className="my-2 rounded" /> */}
          <ul className="list-disc pl-5 text-sm">
            <li>Auto-inserts party details from email</li>
            <li>Customizes clauses by content detected</li>
            <li>Flags missing information before submitting to reviewer</li>
          </ul>
        </ExpandableContent>
      </ExpandableCardContent>
    </ExpandableCard>
